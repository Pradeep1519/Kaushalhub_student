  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Track your academic progress and certifications</p>
      </div>
      ...
      <div className="p-8 text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-gray-600">
            The performance tracking feature is currently under development.
          </p>
          <p className="text-sm text-gray-500 mt-2">
            Grades, certificates, and progress tracking will be available soon.
          </p>
        </div>
      </div>
    </div>
